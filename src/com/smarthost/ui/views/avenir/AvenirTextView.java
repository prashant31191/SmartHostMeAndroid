...
public class AvenirTextView extends TextView {
     ...
     * @see #AvenirTextView(android.content.Context, android.util.AttributeSet, int)
     */
     ...
     * @see #AvenirTextView(android.content.Context, android.util.AttributeSet)
     */
    ...
    private void onInitTypeface(Context context, AttributeSet attrs, int defStyle) {
        ...
        int typefaceValue = 0;
        if (attrs != null) {
            TypedArray values = context.obtainStyledAttributes(attrs, R.styleable.AvenirTextView, defStyle, 0);
            typefaceValue = values.getInt(R.styleable.AvenirTextView_typeface, AvenirTypeFaceManager.DEFAULT);
            values.recycle();
        }

        Typeface robotoTypeface = AvenirTypeFaceManager.obtainTypeface(context, typefaceValue);
