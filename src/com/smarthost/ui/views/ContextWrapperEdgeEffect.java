...
public class ContextWrapperEdgeEffect extends ContextWrapper {
    ...
    private class ResourcesEdgeEffect extends Resources {
        ...
        private int getPlatformDrawableId(String name) {
            try {
                int i = ((Integer) Class.forName("com.android.internal.R$drawable").getField(name)
                        .get(null)).intValue();
                return i;
        ...
        public Drawable getDrawable(int resId) throws Resources.NotFoundException {
            ...
            if (resId == this.overscroll_edge) {
                mEdgeDrawable = ContextWrapperEdgeEffect.this.getBaseContext().getResources()
                        .getDrawable(R.drawable.overscroll_edge);
                ret = mEdgeDrawable;
            } else if (resId == this.overscroll_glow) {
                mGlowDrawable = ContextWrapperEdgeEffect.this.getBaseContext().getResources()
