...
//    protected boolean mIsMiniMonth = false;
    ...
    protected float mClickedXLocation;                // Used to find which day was clicked
    protected long mClickTime;                        // Used to calculate minimum click animation time
    ...
    protected static int mOnDownDelay;
    protected static int mTotalClickDelay;
    // Minimal distance to move the finger in order to cancel the click animation
    protected static float mMovedPixelToCancel;
